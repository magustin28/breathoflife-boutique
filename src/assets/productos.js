const products = [
    ...
    { id: "3", img: "http://drive.google.com/uc?export=view&id=1LlZ3RvJPwBYWWoM_g5TvK1C8Sw4uVC07", name: "Mat Aprendiz Pilates by Oxzen", description: "Mat extra grueso, diseñado específicamente en alianza con OXZEN para la práctica de Pilates Mats. Supercómodo, ligero y hecho de TPE, protegerá tu columna vertebral de superficies duras, mientras te mantenes cómodo durante tu práctica de pilates.", price: "55.000", category: "mat", stock: 70},
